  ...
  render() {
    return (
      ...
      (<>
        ...
        <PeliGrid url={urlEstrenos} titulo="Estrenos" todas="/see-more/category/estrenos"/>
        <PeliGrid url={urlPopulares} titulo="Peliculas Populares" todas="/see-more/category/populares" />
      </>)}
      </>
    );
  }
